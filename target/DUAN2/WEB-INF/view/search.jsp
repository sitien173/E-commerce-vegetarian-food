                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" style="width: 100%;height: 250px; object-fit:cover;" src="<c:url value="${item.images[0].location}"/>">
                            ...
                            <div class="card-body text-center">
                                <a href='<c:url value="/product/${item.id}"/>' style="display: inline-block;max-width: 200px"  class="mb-0 text-uppercase text-truncate">${item.name}</a>
